...
function Navbar() {
    ...
    return (
        <div className="flex justify-between items-center shadow-lg px-10 py-4 fixed w-full bg-gradient-to-b from-green-500 via-green-300 to-green-100 border-none z-20">
            ...
            <div className="flex items-center gap-6">
                ...
                { user!==undefined ? (<Link to="/login" className="hover:font-bold text-white">Login</Link>):(<button className="font-bold" onClick={Logout}>Logout</button>)}
