...
function Navbar() {
    ...
    return (
        <div className="flex flex-col md:flex-row justify-between items-center shadow-lg px-4 md:px-10 py-3 md:py-4 fixed w-full bg-gradient-to-b from-green-500 via-green-300 to-green-100 border-none z-20">
            ...
            <div className="flex flex-col md:flex-row items-center gap-3 md:gap-6">
                ...
                { user === undefined
                    ? (<Link to="/login" className="hover:font-bold text-white">Login</Link>)
